...
@Component
public class ListaAssinaturasAplicativoUC {
    private ServicoDeAssinatura servicoDeAssinatura;

    public ListaAssinaturasAplicativoUC(ServicoDeAssinatura servicoDeAssinatura, AssinaturaInvalidaUC assinaturaInvalidaUC) {
        this.servicoDeAssinatura = servicoDeAssinatura;
    }

    public List<AssinaturaStatusDTO> run(long codigo) {
        List<AssinaturaEntidade> assinaturas = servicoDeAssinatura.getAssinaturasAplicativo(codigo);
