...
public class AssinaturaControlador {
    ...
    public AssinaturaControlador(CriaAssinaturaUC criaAssinaturaUC, AssinaturaInvalidaUC assinaturaInvalidaUC, ListaAssinaturasClienteUC listaAssinaturasClienteUC) {
